...
import 'package:zenta3/splash_screen/splash_screen_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<Zenta3FirebaseUser> userStream;
  Zenta3FirebaseUser initialUser;
  final authUserSub = authenticatedUserStream.listen((_) {});

  @override
  void initState() {
    super.initState();
    userStream = zenta3FirebaseUserStream()
